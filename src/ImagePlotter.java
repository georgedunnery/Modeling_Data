// Image Plotter class provided by instructor.
// Editing the main method at the bottom to generate an image.
...
public class ImagePlotter {
  ...
  /**
   * Constructs an ImagePlotter with default point size, width, and height.
   */
  public ImagePlotter() {
    reset();
    pointSize = 3;
